...
tf.flags.DEFINE_string('input_dir', './dataset/cifar-10/', 'Input directory with images.')
...
"""parameter for PIM"""
tf.flags.DEFINE_float('amplification_factor', 2.5, 'To amplify the step size.')
...
def main(_):
    ...
    with tf.Graph().as_default():
        ...
        if FLAGS.model_name in ['adv_inception_v3','adv_inception_resnet_v2','ens3_adv_inception_v3','ens4_adv_inception_v3','ens_adv_inception_resnet_v2']:
