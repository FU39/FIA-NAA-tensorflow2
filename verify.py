...
def verify(model_name,ori_image_path,adv_image_path):
    ...
    if model_name in ['adv_inception_v3','adv_inception_resnet_v2','ens3_adv_inception_v3','ens4_adv_inception_v3','ens_adv_inception_resnet_v2']:
...
if __name__=='__main__':
    ...
    parser.add_argument('--adv_path',default='./adv/NAA-inception_v3/')
